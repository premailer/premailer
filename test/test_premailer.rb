...
class TestPremailer < Test::Unit::TestCase
  ...
  def atest_mailtos_with_query_strings
    html = <<END_HTML
    <html>
...
END_HTML
  ...
  def atest_importing_remote_css
    remote_setup
